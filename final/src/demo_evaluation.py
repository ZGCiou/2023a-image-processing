...
dataPath = "./result/post/"
gtPath = "./training_dataset/mask/"
mask_filenames_1 = []
mask_filenames_2 = []
for i in range(60):
    mask_filenames_1.append(dataPath + str(i+1) + ".jpg")
    mask_filenames_2.append(gtPath + str(i+1) + ".jpg")

total_iou = 0

for i in range(60):  # 修改為實際的mask數量
    # 讀取兩個mask
